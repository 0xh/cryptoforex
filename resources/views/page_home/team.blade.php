	...
	<main class="main">
		<div class="content">
			<div class="shell column">
				<h1>Meet the team at RMS</h1>
				<p>In any industry where the people behind a company are as important as the company itself, you’re likely to find a kind of expanded “about” page that includes information on individual employees. RMS is introducing you to twelve out of the twenty seven team membersworking every day in collaboration to help your team selling better.</p>
			</div>
			<div class="team">
				<div class="shell wrap">
					<div class="item">
						<div class="top flex">
							...
							<div class="atr">
								<strong>John S. Miley</strong>
								<p>/ Super Smiler, CEO & Founder /</p>
							</div>
						</div>
						<div class="bot">
							<p>
