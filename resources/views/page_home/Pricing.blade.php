	...
	<main class="main">
		<div class="content">
			<div class="shell column">
				<div class="solutions">
					<h1>Secure Ultra-low Latency Data Centers</h1>
					<p>RMS uses the latest servers technology to increase security, steadiness and bugfree workflow.</p>
					<div class="item">
					...
					<div class="item">
						<ul class="flex jsb">
							<li>
								...
								<strong>Dependable data storage</strong>
								<p>You can rely upon our virtual servers featuring N+1 redundancy. We are one of the first ISAE 3402 Type II certified FX tech providers, offering the same level of data security required of the banking industry.</p>
							</li>
							<li>
								<div class="img">
									<i class="ic ic2"></i>
								</div>
								<strong>Speed makes a difference</strong>
								<p>We know that the smallest delays can lower your profits or even turn it to a loss. Our data centers are located in the nearest each currency exchange for ultra-low latency</p>
							</li>
							<li>
								<div class="img">
									<i class="ic ic3"></i>
								</div>
								<strong>Watching 24/7</strong>
								<p>Other data storage providers react when something goes wrong immediately 24/7. We monitor constantly servers and applications 24/7 to ensure trading continuity.</p>
							</li>
						</ul>
					</div>
				</div>
