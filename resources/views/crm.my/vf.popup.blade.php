    ...
    <div class="search">
        <form action="#">
            ...
            <div class="filter_users">
                <select name="status_id" class="loader" data-name="status_id" data-action="/json/user/status" data-autostart="true" data-trigger="change" data-form="#user_list"></select>
            </div>
            <div class="filter_users">
...
<div class="popup user_dashboard" style="position: fixed;">
    <div class="close"></div>
    <div class="top">
...
<div class="popup popup_money_report">
    ...
    <div class="table">
        <span>Total: <span id="transaction_list_total"></span></span>
        <table>
            <thead>
                <tr>
                    <td>Date</td>
