          ...
          <div class="table">
              ...
              <table class="width">
                <thead>
                  ...
                  <th><?php echo app('translator')->getFromJson('messages.open'); ?></th>
                ...
                <tbody class="loader" data-action="/deal?status=open&user_id=<?php echo e(Auth::user()->id); ?>" data-autostart="true" data-refresh="1000" data-function="historyDeals"></tbody>
                </table>
              <?php endif; ?>
        ...
        <div class="tabs__content">
          <div class="table">
              ...
              <table class="width">
                ...
                <tbody class="loader" data-action="/deal?status=close&user_id=<?php echo e(Auth::user()->id); ?>" data-autostart="true" data-refresh="8000" data-function="historyDeals"></tbody>
                </table>
              <?php endif; ?>
